...
exports.create = (req, res) => {
    ...
    const pelicula = {
        ...
        tipo_de_serie: req.body.tipo_de_serie,
    ...
    Pelicula.destroy({
        ...
        .then(num => {
            if (num == 1) {
                ...
                res.send({
                    message: `Cannot delete Client with id=${id}. El pelicula no fue encontado!`
                });
            }
        })
        .catch(err => {
...
// find all active Client, basado en el atributo status vamos a buscar que solo los peliculas activos
